...
import logisticImage from '../assets/img/obm8.jpg';
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-[#0b0d27] text-white py-16 lg:py-20 flex items-center justify-center">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-center tracking-tight">
          {t('activities.logistic_services_title')}
        </h1>
      </div>
            ...
            <div className="bg-white border border-gray-100 rounded-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <ul className="list-disc list-inside space-y-3 text-gray-700 ml-4 font-light">
                  <li className="opacity-90">{t('activities.logistic_services_list_1')}</li>
                  <li className="opacity-90">{t('activities.logistic_services_list_2')}</li>
                  <li className="opacity-90">{t('activities.logistic_services_list_3')}</li>
                  <li className="opacity-90">{t('activities.logistic_services_list_4')}</li>
                  <li className="opacity-90">{t('activities.logistic_services_list_5')}</li>
                </ul>
              </div>
            </div>
          </div>
